            ...
            <div className={styles.container}>

                {
                    mobileDesktopSwitcher({
                        mobile: <img src={basicData.landingMobilePicturePath} className={styles.image} alt={basicData.name}/>,
                        desktop: <img src={basicData.landingPicturePath} className={styles.image} alt={basicData.name}/>
                    })
                }
